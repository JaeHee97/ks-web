...
public class IndexController {
    ...
    public IndexController(PersonRepository personRepository, SocialMediaRepository socialMediaRepository, InterestsRepository interestsRepository, SkillRepositiory skillRepositiory, WorkRepository workRepository) {
    ...
    public String index(Model model) {
        ...
        List<Skill> skills = skillRepositiory.findAll();
